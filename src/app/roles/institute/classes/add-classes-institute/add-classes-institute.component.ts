...
@Component({
  selector: 'app-add-classes-institute',
  templateUrl: './add-classes-institute.component.html',
  styleUrls: ['./add-classes-institute.component.scss']
})
export class AddClassesInstituteComponent implements OnInit {
  ...
  postAPIData(userValues: object) {
    return this.http.post('api/classes/institute/add', userValues);
  }
