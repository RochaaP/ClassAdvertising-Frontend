...
@Component({
  selector: 'app-add-classes-instructor',
  templateUrl: './add-classes-instructor.component.html',
  styleUrls: ['./add-classes-instructor.component.scss']
})
export class AddClassesInstructorComponent implements OnInit {
  ...
  return this.http.post('api/classes/instructor/add', userValues);
  }
